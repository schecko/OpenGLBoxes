...
const static GLfloat DEFTRANSLATIONSPEED = 10000.0f; //to move position
const static GLfloat DEFANGLESENSITIVITY = 1000.0f; //to move yaw and pitch
const static GLfloat DEFZOOMSENSITIVITY = 3.f;
