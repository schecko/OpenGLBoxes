...
//        glDeleteProgram(programID);
        ...
        Debug::Assert(0, "could not link shaders");
    }
...
void Shaders::BindAShaderVariableFloat(GLuint locationInShader, GLfloat variable)
{
    glUniform1f(locationInShader, variable);
}
